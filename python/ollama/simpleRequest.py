...
model = 'llama3-gradient' # TODO: update this for whatever model you wish to use
...
def main():
    ...
    while True:
        user_input = """Im making a 2d game and need to implement movement. So far i have this but its not very good:
class Player:
    def processInputs(self):
        ...
        self.setVelocity(self.getVelocity() + direction/60)
...
Can you implement the standard movement like walking and jumping not dashing or anything more complicated from this class into my own.
Can you just print the modified code with the added movement.
Here is the player class you can take the code from:
using System;
