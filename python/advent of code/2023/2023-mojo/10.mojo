struct Vec2(CollectionElement):
    ...
    fn __init__(inout self: Self, y: Int, x: Int):
        self.x = x
        self.y = y
...
fn move(borrowed data: String, inout pos: Vec2, inout dir: Vec2): # modify inplace
    ...
    if letter == "-" or letter == "|":
        pass
    elif (letter == "7" and dir == Vec2(-1,0)) or (letter == "J" and dir == Vec2(1, 0)):
        dir = Vec2(0, -1)
    elif (letter == "J" and dir == Vec2(0, 1)) or (letter == "L" and dir == Vec2(0,-1)):
        dir = Vec2(-1,0)
    elif (letter == "L" and dir == Vec2(1, 0)) or (letter == "F" and dir == Vec2(-1,0)):
        dir = Vec2(0, 1)
    else:
        dir = Vec2(1, 0)
    pos += dir
...
fn main():
    var data: String = """FF--7-|7F--7F--|7F77-.FJF7F-7-F|7.77.FF7-F7---7-FJ7.|J--FJJ-FF-.JJ7LF7.J7F-7-F77L7.7-7.7FF77FF7..F--L7JF--.FF.7F|JFL7.7FL77.-7|7.F7-7FJ.FJ.-
