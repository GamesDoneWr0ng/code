...
#model = PPO("MlpPolicy", vec_env, verbose=1, ent_coef=0.02, tensorboard_log=f"./python/GoodAI/runs/ppo_{name}/")
model.learn(total_timesteps=30000000, progress_bar=True, tb_log_name="run")
